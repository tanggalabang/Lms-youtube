  ...
  return (
    <>
      <div className="w-full 1000px:flex items-center">
        <div className="absolute top-[100px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[500px] 1100px:w-[500px] h-[50vh] hero-animation rounded-[50%] 1100px:left-[18rem] 1500px:left-[21rem]"></div>
